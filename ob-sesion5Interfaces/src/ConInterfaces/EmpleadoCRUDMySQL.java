...
//Esta sería una clase que suponemos trabajaría sobre una base de datos MySQL con los objetos Empleado
import SinInterfaces.Empleado;

import java.util.List;

public class EmpleadoCRUDMySQL implements EmpleadoCRUD{/*Si solo pusiéramos esta línea, daria un error porque no hemos
